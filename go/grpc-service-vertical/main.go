...
import (
	...
	"grpc-service-vertical/internal/client"
	"grpc-service-vertical/internal/server"
	"grpc-service-vertical/internal/service/greeting"
	"grpc-service-vertical/metadata"
)
